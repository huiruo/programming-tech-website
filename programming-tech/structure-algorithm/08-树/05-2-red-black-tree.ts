import { defaultCompare, ICompareFunction, Compare } from '../models2/util';
import BinarySearchTree from './03-2-binary-search-tree';
import { RedBlackNode, Colors } from '../models2/red-black-node';
