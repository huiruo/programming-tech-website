...
const sidebars = {
  ...
  docs: [
    ...
    },
    {
      ...
      items: [
        ...
        'Vue/01-3-响应式原理与reactive',
        'Vue/00-1-baseCompile生成ast-静态提升-vnode-patch',
        'Vue/mockData-生成的code函数',
        'Vue/mockData-compile调用baseParse返回ast',
        'Vue/patch',
        'Vue/Patch算法之PatchkeyChildren',
        'Vue/01-1-proxy-defineProperty区别',
        'Vue/01-2-proxy',
        'Vue/02-2-Reflect用法',
        'Vue/基础-指令-在html中使用',
        'Vue/问题-v-if和v-for-key-前者优先级更高',
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'JavaScript/01-1-判断是否是数组-判断对象-空对象',
        'JavaScript/01-1-js数据类型-类型转换',
        'JavaScript/01-2-数据类型symbol',
        'JavaScript/01-3-map数据类型-哈希表',
        'JavaScript/01-4-set数据类型',
        'JavaScript/01-5-运算符i++表示先赋值',
        'JavaScript/02-2-keys-hasOwnProperty-defineProperty-forin',
        'JavaScript/03-1-this-箭头函数',
        'JavaScript/03-2-bind-call-apply',
        'JavaScript/高阶函数1-函数式编程-纯函数',
        'JavaScript/高阶函数2-函数式编程-柯里化实现就是return fn',
        'JavaScript/深-浅-拷贝',
        'JavaScript/A-题1-prototype能否取到值吗',
        'JavaScript/A-原型',
        'JavaScript/api-eval',
        {
          label: 'es6',
          ...
          collapsed: true,
          items: [
            'JavaScript/es6-1-es7-es8',
            'JavaScript/es6-2-class-super',
            'JavaScript/es6-3-async',
            'JavaScript/es8-修饰器',
          ]
        },
        {
          ...
          collapsed: true,
          items: [
            'JavaScript/继承/继承-0-es6-extends',
            'JavaScript/继承/继承-1-原型链',
            'JavaScript/继承/继承-2-构造函数继承',
            'JavaScript/继承/继承-3-组合式继承',
            'JavaScript/继承/继承-4-原型式继承',
            'JavaScript/继承/继承-5-寄生式继承',
            'JavaScript/继承/继承-6-1-组合继承的问题',
            'JavaScript/继承/继承-6-寄生组合式继承',
            'JavaScript/继承/继承-6-寄生组合式继承例子2',
            'JavaScript/继承/继承-参考01-js面向对象继承01-高级程序参考',
          ]
        },
        {
          label: 'array方法',
          ...
          collapsed: true,
          items: [
            'JavaScript/A-1-array方法/01-1-array.join把数组转化为string',
            'JavaScript/A-1-array方法/01-2-string.split-string转化成数组',
            'JavaScript/A-1-array方法/04-1-findIndex-找到返回index-否则返回-1',
            'JavaScript/A-1-array方法/04-2-indexOf-找到返回index-否则返回-1',
            'JavaScript/A-1-array方法/04-3-includes-数组是否包含一个指定的值',
            'JavaScript/A-1-array方法/14-1-some-若有一个满足则返回true',
            'JavaScript/A-1-array方法/14-2-every-所有满足则返回true',
            'JavaScript/A-1-array方法/其他-ECMAScript 6和数组的新功能',
            'JavaScript/A-1-array方法/应用1-去重',
            'JavaScript/A-1-array方法/应用2-合并数组-concat-apply',
            'JavaScript/A-1-array方法/A-string.search',
            'JavaScript/A-1-array方法/entries-遍历数组的键名和键值',
            'JavaScript/A-1-array方法/filter-过滤函数',
            'JavaScript/A-1-array方法/find-返回第一个满足条件的是对象',
            'JavaScript/A-1-array方法/lastIndexOf和arr.indexOf区别是从后面开始找',
            'JavaScript/A-1-array方法/map-生成新数组-数组转map结构',
            'JavaScript/A-1-array方法/pop删除最后一个元素',
            'JavaScript/A-1-array方法/reduce-执行函数返回一个值',
            'JavaScript/A-1-array方法/shift删除第一个元素',
            'JavaScript/A-1-array方法/slice返回一个新数组',
            'JavaScript/A-1-array方法/sort-采用快排和插入排序算法',
            'JavaScript/A-1-array方法/splice任意位置删除',
            'JavaScript/A-1-array方法/unshift开头插入',
            'JavaScript/A-1-array方法/values-遍历数组键值',
          ]
        },
        {
          label: 'String方法',
          ...
          collapsed: true,
          items: [
            'JavaScript/A-2-String方法/04-1-substr-substring-slice',
            'JavaScript/A-2-String方法/04-2-js截取字符串',
            'JavaScript/A-2-String方法/exec-执行正则表达式模式匹配的字符串-返回匹配结果的数组',
            'JavaScript/A-2-String方法/indexOf-lastIndexOf',
            'JavaScript/A-2-String方法/match-字符串中搜索指定值并返回数组',
            'JavaScript/A-2-String方法/replace-替换字符串中指定值',
            'JavaScript/A-2-String方法/search-字符串中查找指定值返回-1或值',
            'JavaScript/A-2-String方法/trim',
          ]
        },
        {
          label: 'for常用循环',
          ...
          collapsed: true,
          items: [
            'JavaScript/A-3-for常用循环/正向遍历-反向',
            'JavaScript/A-3-for常用循环/最基础的循环',
            'JavaScript/A-3-for常用循环/for-in-实现深拷贝',
            'JavaScript/A-3-for常用循环/for-of-遍历对象-数组',
            'JavaScript/A-3-for常用循环/forEach',
            'JavaScript/A-3-for常用循环/keys-getOwnPropertyNames',
          ]
        },
        {
          label: 'jsdom操作',
          ...
          collapsed: true,
          items: [
            'JavaScript/A-3-jsdom操作/2021-03-jsDom操作/js操作dom',
            'JavaScript/A-3-jsdom操作/2021-03-jsDom操作/jsDom操作',
            'JavaScript/A-3-jsdom操作/div高度/div高度-宽度',
          ]
        },
        {
          label: 'react-防抖节流',
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            'JavaScript/ts/其他-typeScript',
            'JavaScript/ts/其他-typeScript-TypeScript装饰器',
            'JavaScript/ts/interface-type区别',
            'JavaScript/ts/ts-装饰器',
            'JavaScript/ts/ts-interface-限制函数',
            'JavaScript/ts/ts泛型参数',
            'JavaScript/ts/ts前言',
    ...
    },
    {
      ...
      items: [
        ...
        'build-webpack/00-1-打包原理',
        'build-webpack/Webpack 4-增量构建',
        'build-webpack/05-1-webpack5新特性',
        'build-webpack/05-2-webpack5-Persistent Caching',
        'build-webpack/00-2-loader',
        'build-webpack/00-3-resolve',
        'build-webpack/优化-构建包大小优化',
        'build-webpack/优化-构建速度优化',
        {
          label: 'dynamic-import',
          type: 'category',
          collapsed: true,
          items: [
            'build-webpack/B-2-dynamic-import/动态加载',
            'build-webpack/B-2-dynamic-import/构建动态组件源码',
            'build-webpack/B-2-dynamic-import/vue-react-懒加载',
            'build-webpack/配置实例',
            'build-webpack/配置实例2',
          ]
        },
  ...
  structureAlgorithm: [
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'structure-algorithm/图-深度优先遍历-广度优先遍历/06-1-图的两种遍历',
        'structure-algorithm/图-深度优先遍历-广度优先遍历/07-1-广度优先搜索',
        'structure-algorithm/图-深度优先遍历-广度优先遍历/08-1-图的遍历-深度优先遍历-DFS',
